...
/* 年収150万円: 給与所得85万円。ひとり親でなくても所得税は0円、
...
/* 年収180万円: 給与所得115万円。ひとり親なら135万円以下で住民税は丸ごと0円。
   ひとり親でなければ住民税がかかるので、その全額が「効果」になる。
   所得税はどちらも0円（基礎控除を引くと課税所得が残らない）。 */
var k180 = SPS.ひとり親控除の効果(1800000, 子1人);
eq(k180.incomeTax, 0, '年収180万円では、所得税はもともと0円なので効果も0円');
ok(k180.residentTax > 300000 * 0.10,
  '年収180万円では、住民税が丸ごとかからなくなるので、30万円×10%より効果が大きい');

/* 年収204.4万円・260万円・320万円・450万円:
   所得税の課税所得が残り、税率は5%の帯。
   効果 ＝ 35万円×5%×1.021（所得税） ＋ 30万円×10%（住民税） */
var 理論_所得税 = Math.floor(350000 * 0.05 * 1.021);
[2044000, 2600000, 3200000, 4500000].forEach(function (年収) {
...
[1500000, 1800000, 2044000, 2600000, 3200000, 4500000].forEach(function (年収) {
...
var 前の効果 = -1;
[1500000, 2044000, 2600000, 3200000, 4500000, 6000000].forEach(function (年収) {
...
(function () {
  ...
  ok(man.indexOf('貯金のグラフは0円から始まる') === -1,
    'マニュアルに「貯金のグラフは0円から始まる」と書かれていない');
