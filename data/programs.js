...
(function (root, factory) {
  ...
  "living_cost_growth": {
    "note": "お子さんが大きくなると食べる量が増えるので、そのぶん生活費も増えます。年齢ごとの必要なエネルギー量の比で、食費の部分だけを増やしています。",
    "food_share": 0.3132,
  ...
  "student_loan": {
    ...
    "interest_approx_note": "利子がつく場合の月額は、およその計算です。実際には、卒業してから返し始めるまでの6か月ぶんの利子も乗るので、ここに出る額より少し高くなります。機構の例では、480万円を年3%で借りると月26,914円・総額6,459,510円です。",
    "interest_benchmark": {
