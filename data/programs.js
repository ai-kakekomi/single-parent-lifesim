...
(function (root, factory) {
  ...
  "tuition": {
    ...
    "support": {
      ...
      "high_school": {
        ...
        "shugaku_shienkin_note": "高等学校等就学支援金（令和8年度は所得制限なし。公立118,800円・私立457,200円）は、学校が代わりに受け取って授業料と相殺します。子供の学習費調査の金額は保護者が実際に払った額なので、支援金の分はすでに引かれています（公立高校の授業料は年45,272円で、法律上の授業料118,800円よりずっと少ない）。だから、このツールでは重ねて引きません。引くと、高校が実際よりずっと安く見えてしまいます。",
      ...
      "university": {
        ...
        "income_guide_note": "年収の目安は、世帯の人数やきょうだいの年齢で変わります（ひとり親・子2人（本人と高校生）なら、約270万・360万・430万円まで）。このツールは、国の算式（住民税の課税標準額 × 6% − 調整控除）で区分を出しています。社会保険料を年収の14.5%と置いた見積もりなので、あくまで目安です。tiers の income_max は、いまは計算に使っていません。",
  ...
  "student_loan": {
    ...
    "interest_note": "第一種は無利子です。第二種は利子がつき、上限は年3%と法律で決まっています。利率は貸与が終わる月に決まるので、いま借りる人の利率は先にならないと分かりません。このツールでは「無利子の場合」と「利子がつく場合」の幅で出しています。",
