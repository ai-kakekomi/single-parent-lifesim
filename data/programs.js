  ...
  "tuition": {
    ...
    "support": {
      ...
      "high_school": {
        ...
        "kyufukin_note": "高校生等奨学給付金は、授業料以外（教科書・教材・修学旅行費など）に充てる返さなくてよいお金です。都道府県へ自分で申し込む必要があり、学習費調査の金額には反映されていないので、『使える制度を全部使った場合』の線にだけ入れています。",
        "kyufukin_tiers": [
      ...
      "university": {
        "note": "高等教育の修学支援新制度。授業料・入学金の減免と、返さなくてよい給付型奨学金がセットです。自分で申し込む必要があるので、『使える制度を全部使った場合』の線にだけ入れています。",
        "needs_request": true,
        "tiers": [
