...
(function (root, factory) {
  ...
  "tuition": {
    "note": "学校にかかるお金の、1年分の目安です。すべて全国の平均値です。実際にかかる額は、地域や学校、習いごとの有無で大きく変わります。",
    ...
    "note_kindergarten": "幼稚園・保育所・認定こども園は、3歳から5歳のクラスの利用料が無償になっているため、このアプリでは0円として計算しています（0歳から2歳は住民税非課税世帯が対象）。ただし、給食の食材料費・通園送迎費・行事費は別にかかります。",
    ...
    "support": {
      "note": "学費を助けてくれる制度。低い収入の世帯ほど手厚くなるので、これを入れないと『私立に行ったら終わり』という、実際と違う絵になります。",
      "high_school": {
        "note": "高校の学費については、就学支援金の分はすでに差し引かれています。この表の金額が、保護者が実際に払った額の平均だからです。",
        "shugaku_shienkin_already_deducted": true,
        "shugaku_shienkin_note": "高等学校等就学支援金（令和8年度は所得制限なし。公立118,800円・私立457,200円）は、学校が代わりに受け取って授業料と相殺します。子供の学習費調査の金額は保護者が実際に払った額なので、支援金の分はすでに引かれています（公立高校の授業料は年45,272円で、法律上の授業料118,800円よりずっと少ない）。だから、このアプリでは重ねて引きません。引くと、高校が実際よりずっと安く見えてしまいます。",
      ...
      "university": {
        ...
        "needs_request": true,
        "tiers": [
          { "id": 1, "label": "第Ⅰ区分（住民税非課税。ひとり親・子1人なら年収の目安 約210万円まで）", "income_max": 3000000, "ratio": 1 },
          { "id": 2, "label": "第Ⅱ区分（ひとり親・子1人なら年収の目安 約300万円まで）", "income_max": 4000000, "ratio": 0.6667 },
          { "id": 3, "label": "第Ⅲ区分（ひとり親・子1人なら年収の目安 約370万円まで）", "income_max": 4600000, "ratio": 0.3333 }
        ],
        ...
        "income_guide_note": "年収の目安は、世帯の人数やきょうだいの年齢で変わります（ひとり親・子2人（本人と高校生）なら、約270万・360万・430万円まで）。このアプリは、国の算式（住民税の課税標準額 × 6% − 調整控除）で区分を出しています。社会保険料を年収の14.5%と置いた見積もりなので、あくまで目安です。tiers の income_max は、いまは計算に使っていません。",
  ...
  "training": {
    ...
    "during_income_note": "学校に通う間は働ける時間が減るので、いまの年収の半分を既定にしています。これは制度で決まった数字ではなく、計算のための仮置きです。画面で変えられます。",
    ...
    "after_income_note": "資格を取ったあとの年収は、ご自身で入れていただく見込みの数字です。このアプリは、特定の職種の平均年収を示すことはしません。職種ごとの相場は、下の「仕事・収入の相談」の文章をAIに渡して調べてください。",
    ...
    "track_record_short": "令和5年度は、この給付金を使って2,988人が資格を取り、2,105人が就職しています（看護師・准看護師・保育士など）。",
  ...
  "childcare": {
    ...
    "note_single_parent": "ひとり親世帯には、国基準でも軽い額が定められています（年収330万円・360万円の区分で月9,000円）。このアプリはひとり親家庭を想定しているので、その額を使っています。",
  ...
  "living_cost_growth": {
    "note": "お子さんが大きくなると食べる量が増えるので、その分生活費も増えます。年齢ごとの必要なエネルギー量の比で、食費の部分だけを増やしています。",
    "food_share": 0.3132,
    "food_share_note": "母子世帯の消費支出のうち、食料が占める割合です。住居費と教育費をのぞいた金額（263,111円 − 住居27,559円 − 教育25,240円 = 210,312円）に対する食料65,841円の割合として出しています。生活費のうち、この割合の部分だけがお子さんの成長で増えるものとして計算します。",
    "energy_note": "厚生労働省が定める、1日に必要なエネルギー量（推定エネルギー必要量、身体活動レベル「普通」）の男女の平均です。この比を、食べる量の比として使っています。",
    "energy_bands": [
    ...
    "source_energy": {
      "law": "厚生労働省「日本人の食事摂取基準（2025年版）」策定検討会報告書（令和6年10月）の推定エネルギー必要量（身体活動レベル「普通」）。令和7年度から令和11年度まで使用",
  ...
  "student_loan": {
    "note": "貸与型奨学金（あとで返す奨学金）の返し方。日本学生支援機構の定額返還方式にもとづく計算です。グラフには乗せていません（借りたお金を収入として数えないため）。",
    "repayment_start_note": "返し始めるのは、貸与が終わった月の翌月から数えて7か月目です（3月に終われば10月から）。",
    "max_years": 20,
    "basis_table_note": "貸与総額を「割賦金の基礎額」で割った数（小数点以下切り捨て）が返還年数になります。その12倍が返還回数で、貸与総額をその回数で割ったものが毎月の返還額です。",
    "basis_table": [
      { "max": 200000, "basis": 30000 },
      { "max": 400000, "basis": 40000 },
      { "max": 500000, "basis": 50000 },
      { "max": 600000, "basis": 60000 },
      { "max": 700000, "basis": 70000 },
      { "max": 900000, "basis": 80000 },
      { "max": 1100000, "basis": 90000 },
      { "max": 1300000, "basis": 100000 },
      { "max": 1500000, "basis": 110000 },
      { "max": 1700000, "basis": 120000 },
      { "max": 1900000, "basis": 130000 },
      { "max": 2100000, "basis": 140000 },
      { "max": 2300000, "basis": 150000 },
      { "max": 2500000, "basis": 160000 },
      { "max": 3400000, "basis": 170000 },
      { "max": null, "basis_ratio": 0.05 }
    ],
    "verified_examples": [
      { "total": 1440000, "times": 156, "monthly": 9230, "note": "第一種 月30,000円×48か月" },
      { "total": 2160000, "times": 168, "monthly": 12857, "note": "第一種 月45,000円×48か月" },
      { "total": 2448000, "times": 180, "monthly": 13600, "note": "第一種 月51,000円×48か月" },
      { "total": 2592000, "times": 180, "monthly": 14400, "note": "第一種 月54,000円×48か月" },
      { "total": 3072000, "times": 216, "monthly": 14222, "note": "第一種 月64,000円×48か月" },
      { "total": 3240000, "times": 228, "monthly": 14210, "note": "第一種 月45,000円×72か月" },
      { "total": 3672000, "times": 240, "monthly": 15300, "note": "第一種 月51,000円×72か月" }
    ],
    "interest_max": 0.03,
    "interest_recent": 0.02423,
    "interest_recent_label": "令和8年3月に貸与が終わる場合の利率（利率固定方式）",
    "interest_note": "第一種は無利子です。第二種は利子がつき、上限は年3%と法律で決まっています。利率は貸与が終わる月に決まるので、いま借りる人の利率は先にならないと分かりません。このアプリでは「無利子の場合」と「利子がつく場合」の幅で出しています。",
    "interest_approx_note": "利子がつく場合の月額は、およその計算です。実際には、卒業してから返し始めるまでの6か月分の利子も乗るので、ここに出る額より少し高くなります。機構の例では、480万円を年3%で借りると月26,914円・総額6,459,510円です。",
    "interest_benchmark": {
      "total": 4800000, "times": 240,
      "rates": [
        { "rate": 0.005, "monthly": 21069, "totalPaid": 5056654 },
        { "rate": 0.01, "monthly": 22172, "totalPaid": 5321420 },
        { "rate": 0.02, "monthly": 24478, "totalPaid": 5874754 },
        { "rate": 0.03, "monthly": 26914, "totalPaid": 6459510 }
      ],
      "source_note": "日本学生支援機構が公表している返還例（第二種・月額10万円×4年）"
    },
    "first_type_max_monthly": {
      "note": "第一種（無利子）で借りられる、大学生の1か月の上限額",
      "national_home": 45000, "national_away": 51000,
      "private_home": 54000, "private_away": 64000
    },
    "academic_note": "第一種（無利子）を借りるには、高校の評定平均値が5段階で3.5以上であることが基準です。ただし、生計維持者の貸与額算定基準額が0円（住民税非課税に相当）の世帯、生活保護を受けている世帯、社会的養護を必要とする人は、この基準を満たさなくても、学ぶ意欲があると学校から推薦されれば学力基準を満たすものとして扱われます。",
    "academic_lever_note": "評定平均3.5は、利子を消します。同じ額を借りても、無利子と有利子では返す総額が変わります。",
    "academic_source": {
      "law": "日本学生支援機構「進学前（予約採用）の第一種奨学金の学力基準」。「高等学校等における申込時までの全履修科目の評定平均値が、5段階評価で3.5以上であること」。生計維持者の貸与額算定基準額が0円である場合等は、基準を満たさなくても学力基準を満たす者として取り扱う",
      "url": "https://www.jasso.go.jp/shogakukin/about/taiyo/taiyo_1shu/gakuryoku/yoyaku.html",
      "publisher": "日本学生支援機構",
      "last_verified": "2026-08-11"
    },
    "order_note": "これは、お子さんが社会人になってから返すお金です。返さなくていいお金（給付型奨学金・授業料の減免）を使い切ってから考えるものです。",
    "source": {
      "law": "独立行政法人日本学生支援機構 奨学金 定額返還方式（奨学金返還年数算出表・返還例）",
      "url": "https://www.jasso.go.jp/shogakukin/henkan/houhou/henkan_hoshiki/henkan_kikan/index.html",
      "url_detail": "https://www.jasso.go.jp/shogakukin/henkan/houhou/henkan_hoshiki/kappu/sample/daigaku.html",
      "publisher": "日本学生支援機構",
      "last_verified": "2026-08-11"
    }
  },
  ...
  "programs": [
    {
      ...
      "benefit_summary": "お子さん1人なら、全部支給で月48,050円。2人目からは1人につき月11,350円が足されます。所得が全部支給の限度額を超えると、そこから少しずつ減っていきます（一部支給）。",
    ...
    },
    {
      ...
      "eligibility": {
        ...
        "resident_tax_limit_note": "ひとり親でない場合でも、合計所得金額が「35万円×（本人＋扶養の数）＋10万円＋（扶養がいれば21万円）」以下なら均等割がかからず、「同じ計算で21万円を32万円に置きかえた額」以下なら所得割がかかりません。35万円と21万円は、お住まいの地域（生活保護の級地区分）によってこれより低いことがあります。このアプリは条文の上限値で計算しているので、実際より税が軽く出ることがあります。"
      },
    ...
    },
    {
      ...
      "eligibility": {
        "note": "誰が対象になるかは市区町村ごとに決めています。このアプリでは判定できません。",
        "typical_standard": "生活保護の基準額に一定の倍率をかけた額を基準にしている市町村が79.2%（1,397／1,763）。そのうち1.3倍以下としているところが45.6%で一番多い。",
      ...
      "cautions": [
        ...
        "給食費も対象です。食費の負担が重いときは、この就学援助と、こども食堂などの食の支援を合わせて考えてください。"
      ],
      "source": {
        "law": "学校教育法第19条",
    ...
    },
    {
      ...
      "eligibility": {
        "note": "所得の基準で自動的に軽くなる部分（法定軽減）と、事情を申し立てて軽くしてもらう部分（条例減免）があります。金額や運用は市区町村ごとに違うため、このアプリでは判定できません。",
    ...
    },
    {
      ...
      "eligibility": {
        "note": "収入基準も、ひとり親をどう優遇するかも、自治体の条例で決まります。このアプリでは判定できません。",
        "income_standard_general": 158000,
        "income_standard_discretionary": 259000,
        "income_standard_note": "月収（政令月収）の全国的な目安は158,000円。高齢者や小学校就学前のお子さんがいる世帯などは259,000円まで広げられます。収入の計算ではひとり親控除35万円などが引かれます。",
    ...
    },
    {
      ...
      "judgment_type": "check",
      "repayment": "none",
      "summary": "大学・短大・高専・専門学校の授業料や入学金を減らし、合わせて返さなくてよい奨学金を受け取れる制度です。",
      ...
      "benefit_summary": "住民税が非課税の世帯なら、私立大学で自宅外から通う場合、返さなくてよい奨学金が年91万円。合わせて授業料が年70万円まで、入学金が26万円まで免除されます。",
    ...
    },
    {
      ...
      "eligibility": {
        "note": "このアプリでは金額の計算をしません。最低生活費はお住まいの地域・世帯の人数・年齢で変わるためです。該当するかどうかは福祉事務所で確認してください。",
    ...
    },
    {
      ...
      "cautions": [
        "「もめたくないから」と口約束で済ませるのが、一番多い落とし穴です。",
    ...
    },
    {
      ...
      "eligibility": {
        "note": "あるかないか、だれが使えるかは地域ごとに違います。このアプリでは判定しません。多くのこども食堂は、だれでも来ていい形にしています。",
      ...
      "how_to_apply": "お住まいの市区町村の子育て支援担当課、または社会福祉協議会に「近くのこども食堂やフードパントリーを教えてください」と聞くのが一番早いです。むすびえのサイト（https://musubie.org/search）でも探せます。フードバンクは、農林水産省の「フードバンクオープンリスト」から地域の団体をたどれます。",
      "cautions": [
