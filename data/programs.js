...
(function (root, factory) {
  ...
  "programs": [
    ...
    },
    {
      ...
      "cautions": [
        "カードローンや消費者金融に手を出す前に、必ずこちらを先に相談してください。利率がまったく違います。",
    ...
    },
    {
      ...
      "eligibility": {
        ...
        "food_bank": "フードバンク。農林水産省の説明では「食品企業の製造工程で発生する規格外品などを引き取り、福祉施設等へ無料で提供する団体・活動」です。こども食堂やこども宅食に食品を提供しています。",
      ...
      "how_to_apply": "お住まいの市区町村の子育て支援担当課、または社会福祉協議会に「近くのこども食堂やフードパントリーを教えてください」と聞くのがいちばん早いです。農林水産省のページからは、地域のフードバンク団体の一覧をたどれます。",
      "cautions": [
      ...
      "source": {
        ...
        "url_detail": "https://www.maff.go.jp/j/shokusan/recycle/syoku_loss/foodbank.html",
