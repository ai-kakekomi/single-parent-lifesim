...
(function (root, factory) {
  ...
  "note": "ここに出てくる人はすべて架空です。実在の方とは関係ありません。動きを試すためと、計算が正しいかを確かめるための例として用意しています。画面の『例で試す』と、開発用の自動チェックの両方が、この同じ数字を使っています。",
  "samples": [
    {
      "id": "part_two_kids",
      "label": "パート勤務・保育園児と小学生のお母さん",
      "story": "パートで年150万円。5歳と8歳のお子さんと賃貸暮らし。養育費は取り決めをしていません。毎月の生活費88,000円は、かなり切り詰めた場合の目安です（親子3人・住居費と学校のお金をのぞく）。",
      "input": {
        "isSingleParent": true,
        "myAge": 34,
        "myIncome": 1500000,
    ...
    },
    {
      ...
      "label": "離婚を考えている段階・パート勤務のお母さん",
      "story": "いまは婚姻中。ご自身はパートで年110万円、配偶者は年500万円。1歳と4歳のお子さん。離婚したら家賃6万5千円のところへ移ることを考えています。養育費は月4万円で話がまとまりそうです。離婚後の生活費95,000円は、かなり切り詰めた場合の目安です（親子3人・住居費と学校のお金をのぞく）。",
      "input": {
    ...
    {
      "id": "on_the_edge",
      "label": "あと少しで手当が減るところにいるお母さん",
      "story": "年190万円。7歳のお子さんが1人。全部支給のちょうど境目にいます。あと1万円多く稼ぐと、手当が減り始めます。",
      "input": {
        "isSingleParent": true,
        "myAge": 36,
        "myIncome": 1900000,
