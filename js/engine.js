  ...
  function シミュレーション(入力, データ) {
    ...
    for (var y = 0; y < 年数; y++) {
      ...
      years.push({
        ...
        youngestAge: 末子 + y,
        childAges: ages,
        married: { takehome: 婚姻中手取り月, jidoTeate: 婚児手, jidoFuyoTeate: 0, childSupport: 0, parentSupport: 婚親支援, housing: (入力.housingNow || 0), total: 婚合計 },
        divorced: { takehome: 自分手取り月, jidoTeate: 離児手, jidoFuyoTeate: 離児扶.monthly, jidoFuyoTeateStatus: 離児扶.status, childSupport: 養育費月, parentSupport: 離親支援, housing: (入力.housingAfter || 0), total: 離合計 }
      });
    }
